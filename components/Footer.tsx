...
const socialLinks = [
  { href: 'https://github.com/Abdurrahman2881', icon: Github, label: 'GitHub' },
  { href: 'https://www.linkedin.com/in/abdur-rahman-287821343', icon: Linkedin, label: 'LinkedIn' },
  { href: 'mailto:adurrr123@gmail.com', icon: Mail, label: 'Email' },
]
