...
import { Mail, Linkedin, Phone, ArrowRight, CheckCircle } from 'lucide-react'
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-start">
        ...
        <div className="lg:sticky lg:top-32">
          ...
          <div className="flex flex-col gap-4">
            ...
            >
              <div className="w-10 h-10 rounded-lg bg-[#00dbe7]/10 flex items-center justify-center flex-shrink-0 group-hover:bg-[#00dbe7]/20 transition-colors">
                <Phone size={18} className="text-[#00dbe7]" />
              </div>
              <div>
                <p className="text-xs text-slate-600 mb-0.5 font-medium tracking-wider uppercase">Phone</p>
                <p className="text-white text-sm font-medium group-hover:text-[#00dbe7] transition-colors">
                  0821-2542-7594
                </p>
              </div>
            ...
            >
              ...
              <div>
                ...
                <p className="text-white text-sm font-medium group-hover:text-[#00dbe7] transition-colors">
                  linkedin.com/in/abdur-rahman-287821343
                </p>
              </div>
              <ArrowRight
                size={16}
