...
const techStack = [
  {
    group: 'Languages',
    items: ['JavaScript', 'TypeScript', 'PHP', 'Golang'],
  },
  {
    group: 'Backend',
    items: ['Laravel', 'Express.js', 'CodeIgniter', 'Gin-gonic'],
  },
  {
    group: 'Frontend',
  ...
  },
  {
    ...
    items: ['Docker', 'Git', 'Nginx', 'Linux'],
  },
]

const socialLinks = [
  { label: 'GitHub', href: 'https://github.com/Abdurrahman2881', initial: 'GH' },
  { label: 'LinkedIn', href: 'https://www.linkedin.com/in/abdur-rahman-287821343', initial: 'in' },
    ...
    <div className="pb-24 px-5 md:px-20 max-w-[1200px] mx-auto">
      ...
      <section className="relative min-h-[calc(100vh-68px)] grid grid-cols-1 md:grid-cols-2 gap-0 items-center">
        ...
        <div className="flex flex-col justify-center py-20 md:py-0 md:pr-12 lg:pr-20 relative z-10">
          ...
          {/* About Me summary from official CV */}
          <p className="mt-5 text-[15px] leading-[1.75] text-slate-400 max-w-[460px]">
            A Full-Stack Developer with a strong interest in application development. Began a
            career in 2021 as a computer lab assistant and has continued to grow professionally,
            currently focusing on deepening expertise in{' '}
          ...
          <div className="mt-14 flex items-center gap-8 border-t border-[#1e2130] pt-8">
            <div>
              <p className="font-display text-3xl font-extrabold text-white tracking-tight">5+</p>
              <p className="text-xs text-slate-600 mt-1 tracking-wide uppercase font-medium">Years in Tech</p>
            </div>
            <div className="w-px h-10 bg-[#1e2130]" />
            <div>
              <p className="font-display text-3xl font-extrabold text-white tracking-tight">4</p>
              <p className="text-xs text-slate-600 mt-1 tracking-wide uppercase font-medium">Roles Held</p>
            </div>
            <div className="w-px h-10 bg-[#1e2130]" />
            <div>
              <p className="font-display text-3xl font-extrabold text-[#00dbe7] tracking-tight">100%</p>
              <p className="text-xs text-slate-600 mt-1 tracking-wide uppercase font-medium">Financial Accuracy</p>
            </div>
          </div>
        </div>
          ...
          <div className="flex flex-col lg:flex-row">
            ...
            <div className="lg:w-[45%] p-8 lg:p-12 flex flex-col justify-center">
              <div className="flex flex-wrap gap-2 mb-6">
                {['Laravel', 'Eloquent ORM', 'Docker'].map((tag) => (
                  <span
                    key={tag}
              ...
              <h3 className="font-display text-2xl font-bold text-white mb-4 group-hover:text-[#00dbe7] transition-colors duration-300">
                Sirul Tour &amp; Travel — Integrated ERP System
              </h3>

              <p className="text-slate-400 leading-relaxed mb-8 text-sm">
                An integrated ERP system connecting three core modules — Hajj &amp; Umrah package
                e-commerce, real-time inventory, and finance. A webhook-based payment gateway
                verifies transactions instantly, automatically triggering stock deduction and
                financial journal entries with zero manual intervention.
              </p>
              ...
              <div className="flex items-start gap-4 p-5 rounded-xl bg-[#00dbe7]/5 border border-[#00dbe7]/10 mb-8">
                ...
                <div>
                  ...
                  <p className="text-white font-bold text-xl">
                    100% Accuracy in Financial Reports
                  </p>
                </div>
              </div>
